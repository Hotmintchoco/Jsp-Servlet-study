...
<div id="all">
	...
	<section>
		...
		<form action="insertCourseImpl.jsp" method="post">
		
		<table>
			<tr>
				<td>교과목 코드</td>
				<td><input name="id" size="90%"></td>
			</tr>
			<tr>
				<td>과목명</td>
				<td><input name="courseName" size="90%"></td>
			</tr>
			<tr>
				<td>담당강사</td>
				<td>
			...
			<tr>
				<td>학점</td>
				<td><input name="credit" size="90%"></td>
			</tr>
			<tr>
				<td>요일</td>
				<td>
			...
			<tr>
				<td>시작</td>
				<td><input name="start" size="90%"></td>
			</tr>
			<tr>
				<td>종료</td>
				<td><input name="end" size="90%"></td>
			</tr>
		</table>
